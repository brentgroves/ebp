...
export default class Reports extends Component {
  ...
  render() {
    ...
    if(STATE.OPENPOEMAIL_NO_RECORDS==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.OPENPOEMAIL_DATE_RANGE_NO_RECORDS==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.OPENPOEMAIL_DATE_RANGE_NOT_READY==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.OPENPOEMAIL_DATE_RANGE_READY==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.POWITHRECEIVERS_DATE_RANGE_READY==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.POWITHRECEIVERS_DATE_RANGE_NO_RECORDS==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(
        (STATE.POWITHRECEIVERS_DATE_RANGE_NOT_READY==this.props.Rpt.state) ||
        (STATE.POWITHRECEIVERS_DATE_RANGE_READY==this.props.Rpt.state)
      )
    {
    ...
    /////////////////////////////////////////////////////////////////
    if(STATE.PONORECEIVERS_DATE_RANGE_NOT_READY==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.PONORECEIVERS_DATE_RANGE_READY==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.PONORECEIVERS_DATE_RANGE_NO_RECORDS==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.STARTED==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.FAILURE==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(STATE.SUCCESS==this.props.Rpt.state){
      jumboTronTxt=
        <Row >
          <Col xs={1}>&nbsp;</Col>
          <Col >
    ...
    if(
        (STATE.SUCCESS==this.props.Rpt.state)  || 
        (STATE.NOT_STARTED==this.props.Rpt.state) ||
        (STATE.POWITHRECEIVERS_DATE_RANGE_NO_RECORDS==this.props.Rpt.state) ||
        (STATE.POWITHRECEIVERS_DATE_RANGE_NOT_READY==this.props.Rpt.state) ||
        (STATE.POWITHRECEIVERS_DATE_RANGE_READY==this.props.Rpt.state) ||
        ...
        (STATE.OPENPOEMAIL_PROMPT_NOT_READY==this.props.Rpt.state) ||
        (STATE.OPENPOEMAIL_PROMPT_READY==this.props.Rpt.state) ||
        (STATE.OPENPOEMAIL_NO_RECORDS==this.props.Rpt.state) ||
        (STATE.OPENPOEMAIL_DATE_RANGE_NO_RECORDS==this.props.Rpt.state) 
      )
    {
      navbar =
